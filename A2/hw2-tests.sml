...
val test1_0 = all_except_option("foo", ["bar"]) = NONE
val test2_0 = get_substitutions1([
            [],
            ["a"],
            ["a", "a"],
            ["a", "a", "a"]
        ], "a") = ["a", "a", "a"]
val test3_0 = get_substitutions2([
            [],
            ["a"],
            ["a", "a"],
            ["a", "a", "a"]
...
val test6_0 = card_value(Clubs, Jack) = 10
val test7_0 =
    let
        exception howDareYou
    in
        remove_card([], (Clubs, Jack), howDareYou) = []
                handle howDareYou => true
    end
val test8_0 = all_same_color([(Clubs, Jack)]) = true
val test9_0 = sum_cards([(Clubs, Jack)]) = 10
val test10_0 = score([(Clubs, Jack), (Diamonds, Jack)], ~1) = 42
val test11_0 = officiate(cards3, [Draw, Discard(Clubs, Ace),
        Draw, Discard(Diamonds, Num 10), Draw, Discard(Spades, Num 5),
        Draw, Discard(Clubs, Num 9)], 100) = 50
